...
function showNameForm() {
    questionEl.textContent = "Enter your name to start the 4th Quarter Grade 10 - ESP Examination";
...
function renderQuestion() {
    ...
    if (current >= questions.length) {
        ...
        questionEl.innerHTML = (studentName ? (studentName + ", ") : "") + 
            "Tapos na ang pagsagot mo sa 4th Quarter Grade 10 - ESP Examination.<br>" +
    ...
    try {
        ...
        if (txt) {
            ...
            if (parsed && parsed.length) {
                ...
                const groupedQuestions = groupDependentQuestions(questions, 10);
